...
namespace decs
{
	...
	Archetype* Container::FindSpawnArchetype(Archetype* prefabArchetype, Container* prefabContainer)
	{
		if (prefabArchetype == nullptr) return nullptr;
		if (prefabContainer == this) return prefabArchetype;
