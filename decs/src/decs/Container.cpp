...
namespace decs
{
	...
	)
	{
		...
		AddSpawnedEntityToArchetype(spawnedEntity->ID(), m_SpawnData.m_SpawnArchetype);
	...
	)
	{
		...
		spawnArchetype->m_EntitiesData.emplace_back(entityID, data.m_IsActive, data.m_EntityPtr);
