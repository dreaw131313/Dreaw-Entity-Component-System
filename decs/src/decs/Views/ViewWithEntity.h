...
namespace decs
{
	...
	private:
		...
		struct BaseIterator
		{
			using ViewType = ViewBaseWithEntity <ComponentsTypes...>;
		...
		protected:
			...
			{
				std::get<Entity>(m_DataTuple) = Entity();
	...
	class View<Entity, Types...> : public ViewBaseWithEntity<Types...>
	{
		using ArchetypeContext = ViewArchetypeContext<sizeof...(Types)>;
		using ArchetypeContext = ViewArchetypeContext<sizeof...(Types)>;
